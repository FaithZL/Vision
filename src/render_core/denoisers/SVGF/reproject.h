...
public:
    ...
    [[nodiscard]] Bool is_neighbor(const OCPixelGeometry &cur, const OCPixelGeometry &neighbor) const noexcept;
    [[nodiscard]] Bool load_prev_data(const OCPixelGeometry &geom_data, const Float2 &motion_vec,
