...
public:
    ...
    SampledDirection sample_wi(Float3 wo, Uint flag, TSampler &sampler) const noexcept override {
        SampledDirection sd;
    ...
    BSDFSample sample_local(Float3 wo, Uint flag, TSampler &sampler) const noexcept override {
