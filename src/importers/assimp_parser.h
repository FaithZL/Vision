...
public:
    ...
    [[nodiscard]] SP<vision::LightImpl> point_light(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<vision::LightImpl> spot_light(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<vision::LightImpl> area_light(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<vision::LightImpl> environment(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<vision::LightImpl> directional_light(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<vision::LightImpl> parse_light(aiLight *ai_light) noexcept;
    [[nodiscard]] vector<SP<vision::LightImpl>> parse_lights() noexcept;
