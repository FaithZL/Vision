...
public:
    ...
    [[nodiscard]] SP<LightImpl> point_light(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<LightImpl> spot_light(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<LightImpl> area_light(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<LightImpl> environment(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<LightImpl> directional_light(aiLight *ai_light) noexcept;
    [[nodiscard]] SP<LightImpl> parse_light(aiLight *ai_light) noexcept;
    [[nodiscard]] vector<SP<LightImpl>> parse_lights() noexcept;
