...
public:
    ...
    [[nodiscard]] Light point_light(aiLight *ai_light) noexcept;
    [[nodiscard]] Light spot_light(aiLight *ai_light) noexcept;
    [[nodiscard]] Light area_light(aiLight *ai_light) noexcept;
    [[nodiscard]] Light environment(aiLight *ai_light) noexcept;
    [[nodiscard]] Light directional_light(aiLight *ai_light) noexcept;
    [[nodiscard]] Light parse_light(aiLight *ai_light) noexcept;
    [[nodiscard]] vector<Light> parse_lights() noexcept;
