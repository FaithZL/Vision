...
public:
    ...
    [[nodiscard]] LightSample sample_wi(const LightSampleContext &lsc, SamplerImpl *sampler,
    ...
    [[nodiscard]] LightSurfacePoint sample_only(const LightSampleContext &lsc, SamplerImpl *sampler) const noexcept;
