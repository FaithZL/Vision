...
public:
    ...
    [[nodiscard]] virtual SampledSpectrum decode_to_albedo(Float3 rgb,  const SampledWavelengths &swl) const noexcept = 0;
    [[nodiscard]] virtual SampledSpectrum decode_to_illumination(Float3 rgb, const SampledWavelengths &swl) const noexcept = 0;
};
