...
BSDFSample BxDF::sample(Float3 wo, SamplerImpl *sampler, SP<Fresnel> fresnel) const noexcept {
...
BSDFSample MicrofacetReflection::sample(Float3 wo, SamplerImpl *sampler, SP<Fresnel> fresnel) const noexcept {
    BSDFSample ret{swl().dimension()};
    auto [wi, pdf] = sample_wi(wo, sampler->next_2d(), fresnel);
...
BSDFSample MicrofacetTransmission::sample(Float3 wo, SamplerImpl *sampler, SP<Fresnel> fresnel) const noexcept {
    BSDFSample ret{swl().dimension()};
