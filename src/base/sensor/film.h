...
public:
    ...
    virtual void update_sample(const Uint2 &pixel, Float4 val, const Uint &frame_index) noexcept = 0;
    virtual void update_sample(const Uint2 &pixel, const Float3 &val, const Uint &frame_index) noexcept {
        update_sample(pixel, make_float4(val, 1.f), frame_index);
    }
